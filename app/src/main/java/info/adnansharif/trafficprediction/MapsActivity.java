...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        long1 = extras.getDouble("long1");
        lat2 = extras.getDouble("lat2");
        long2 = extras.getDouble("long2");
        time = extras.getString("time");

        Log.e("lat", String.valueOf(lat1));
        Log.e("long", String.valueOf(long1));
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraPosition cameraPosition = new CameraPosition.Builder().target(new LatLng((lat1+lat2)/2.0, (long1+long2)/2.0)).zoom(14.0f).build();
